...
\begin{textblock*}{12.8cm}(0.025cm,2.6cm) % {block width} (coords)
\begin{columns}
	\column[t]{6.5cm}
	\vspace{-0.35in}
	\begin{figure}[t]
	\begin{overprint}
		\onslide<1>\includegraphics[height=0.65\textheight]{../dissertation/figures/ch3/major_isotopes_adens.png}
		\vspace{-0.15in}
		\caption{Number density of major isotopes in the salt
			during 60 years of operation \cite{rykhlevskii_advanced_2018}.}
		\onslide<2->\includegraphics[height=0.65\textheight]{../dissertation/figures/ch3/spectrum.png}
		\vspace{-0.15in}
...
\begin{figure}[htp!] % replace 't' with 'b' to 
	\begin{overprint}
		\onslide<1>\centerline{\includegraphics[height=0.75\textheight]{./images/347_base_2.png}}
...
\begin{textblock*}{12.4cm}(0.07cm,1.9cm) % {block width} (coords)
	\begin{columns}
		...
		\begin{textblock*}{7.2cm}(5.5cm,1.7cm) % {block width} (coords)
			...
			uncertainty $\times100$ greater than stochastic}
