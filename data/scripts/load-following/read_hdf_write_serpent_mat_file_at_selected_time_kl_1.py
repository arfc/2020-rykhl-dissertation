...
db_file = os.path.join(os.getcwd(),
                       '../../db/long_term_eps_var/eps_50_kl_25.h5')
# new_mat_file = '../../load-following/small_eps/mat_kl_1_bol_boc_9d.ini'
# new_mat_file = '../../load-following/small_eps/bol/eoc_-30d/mat_kl_1_bol_eoc_-30d_dec.ini'
# new_mat_file = '../../load-following/small_eps/eol/eoc_-0d/mat_kl_1_eol_eoc_8448d.ini'
# new_mat_file = '../../load-following/small_eps/eol/moc/mat_kl_1_eol_moc_8304d.ini'
# new_mat_file = '../../load-following/small_eps/mol/moc/mat_kl_1_mol_moc_4233d.ini'
new_mat_file = '../../load-following/medium_eps/eol/eoc/mat_kl_25_eol_eoc.ini'
...
# time_after_startup = 4233.0   # geo #8, 840.ini, MOC
