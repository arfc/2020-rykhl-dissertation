...
\usepackage{enumitem}
\usepackage{placeins}
\usepackage{threeparttable,tabularx,booktabs}
...
%
\begin{dedication}
To my parents and my wife, Nelli, for their unconditional love and support.\\
To my daughters, Sofiya and Zoe, for being an inspiration.
\end{dedication}
