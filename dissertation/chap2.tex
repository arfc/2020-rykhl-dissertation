...
\begin{figure}[htp!] % replace 't' with 'b' to 
	...
	\caption{Preliminary concept of \gls{MSBR} bubble generator (reproduced 
...
Some fraction of noble and semi-noble solid fission products plate out onto 
the internal surfaces of the primary loop equipment, complicating their 
removal \cite{briggs_molten-salt_1964}. The remains noble and semi-noble 
...
filter is huge due to the undissolved fission products and residual fuel 
