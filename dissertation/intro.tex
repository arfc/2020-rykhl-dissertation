...
Nuttin \emph{et al.} developed in-house depletion code REM, which directly 
...
validation procedures and unavailable for external users.

Most of the existing tools in the literature represented fuel salt 
